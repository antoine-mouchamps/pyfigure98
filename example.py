...
if __name__ == "__main__":
    ...
    angular.plotStandard(x=x, y=y, label="sin(x)", color="red", linestyle="dashed")
    angular.setAxisYSecondAxis(-2.5, 2.5, "angle", color=["blue", True], loc="top")
    angular.plotStandard(axis="sec", x=x2, y=y2, label="cos", color="blue", linestyle="dotted", linewidth=3)
